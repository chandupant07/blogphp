      ...
      <div class="app-content">
        ...
        <div class="container-fluid">
          ...
          if (isset($_POST['addBlog'])) {
            ...
            $blogInsert = mysqli_query($con, "INSERT INTO blog_tbl (title,description,img,category,author,status) 
            VALUES ('$blogTitle','$blgDes','$destination','$categoryBlog','$blgAuth','$status')");
                      ...
                      <div class="col-12" class="form-group">
                        ...
                        <div class="col-6 m-3">
                          ...
                          <select class="form-control" name="categoryBlog">
                            ...
                            <?php
                            $getData = mysqli_query($con, "SELECT * FROM category_tbl");
                            if ($row = mysqli_num_rows($getData)) {
                              ?>
                              <option>--select--</option>
                              <?php
                              for (; $row = mysqli_fetch_assoc($getData); ) {
                                ?>
                        ...
                        <div class="col-md-6 m-3">
                          ...
                          <textarea class="form-control" name="blgDes" id="editor"></textarea>
                        </div>

                        <div class="col-md-4 m-3">
                          <input type="submit" class="btn btn-success" name="addBlog" value="submit" />
                        </div>
                      </div>
                    </div>
                  </div>
